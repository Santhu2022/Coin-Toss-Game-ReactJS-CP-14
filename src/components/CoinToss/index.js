    ...
    return (
      <div className="main-bg-container">
        <div className="app-container">
          <h1 className="app-name">Coin Toss Game</h1>
          ...
          <div className="counts-container">
            <p className="counts-text">Total: {heads + tails}</p>
            <p className="counts-text">Heads: {heads}</p>
            <p className="counts-text">Tails: {tails}</p>
          </div>
        </div>
      </div>
    )
